...
#define CCID_EMU_MAX_RULES       24 /* 24 × ~200 B = ~4.7 KB per card   */
#define CCID_EMU_MAX_APDU_LEN    64 /* needed for full PIV CHUID + SW   */
#define CCID_EMU_MAX_NAME_LEN    64
#define CCID_EMU_MAX_DESC_LEN    128
#define CCID_EMU_MAX_HEX_STR     (CCID_EMU_MAX_APDU_LEN * 3)
#define CCID_EMU_LOG_MAX_ENTRIES 10 /* ring buffer for monitor          */
