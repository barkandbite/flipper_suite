...
static const char piv_card_content[] =
    ...
    /* 53 1A: outer Discretionary Data (26-byte body).
     * 30 18: FASC-N tag (24-byte body) — matches the first 24 bytes of the
     * external piv_emulator.ccid sample. Was 30 19 (length 25) over a 14-byte
     * body, which is invalid BER-TLV and breaks strict PIV middleware parsers.
     * Response total: 30 bytes, within CCID_EMU_MAX_APDU_LEN (32). */
    "00 CB 3F FF 05 5C 03 5F C1 02 = 53 1A 30 18 D4 E7 39 DA 73 9C ED 39 CE 73 9D 83 68 58 49 27 01 01 01 01 01 01 01 01 90 00\n"
