...
static const char piv_card_content[] =
    ...
    "# FASC-N length is 0x0E (14 bytes) to match the truncated payload; the\n"
    "# 32-byte response cap prevents a full PIV CHUID — use the standalone\n"
    "# piv_emulator.ccid for a complete CHUID with GUID and expiry tags.\n"
