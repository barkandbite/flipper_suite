...
- **evil_ble**: Never reviewed. Likely has the same UART teardown race (NULL context guard) and volatile annotation needs as the other three ESP32 UART apps. Priority for next review.
